...
namespace eCAL
{
  namespace UDP
  {
    ...
    {
      My_timestamps::make_timestamp("Entered UDP::CSampleSender::Send");
      // ------------------------------------------------
      ...
      My_timestamps::make_timestamp("Set asio stuff");
      ...
      if (ec)
      {
        My_timestamps::make_timestamp("CSampleSender::Send failed with: " + ec.message());
        std::cout << "CSampleSender::Send failed with: \'" << ec.message() << "\'" << '\n';
        return 0;
      }
      My_timestamps::make_timestamp("(UDP::CSampleSender) Sent it");
      return sent;
    }
  }
}
